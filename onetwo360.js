...
(function() {
  ...
  if (!isNodeJs) {
    ...
    (function() {
      ...
      log = function() {
        ...
        logData.push([+(new Date())].concat(slice.call(args)));
  ...
  if (!isNodeJs) {
    ...
    if (runTest) {
      ...
      ajax("./testdata/config.js", void 0, function(_, x) {
        ...
        for (j = 0, len = ref.length; j < len; j++) {
          ...
          results.push(testModel.frames.zoom.urls.push("" + o.zoom));
        }
        return results;
      });
      (function() {
  ...
  if (!isNodeJs) {
    View = function(model, domId) {
      var _, buttonStyle, domElem, elemNames, i, j, key, ref, ref1;
      this.model = model;
      ...
      for (i = j = 1, ref = elemNames.length - 1; 1 <= ref ? j <= ref : j >= ref; i = 1 <= ref ? ++j : --j) {
    ...
    View.prototype._applyStyle = function() {
      var css, e, elemId, key, ref, results, val;
      ref = this.style;
      results = [];
      for (elemId in ref) {
        css = ref[elemId];
        results.push((function() {
          ...
          for (key in css) {
            ...
            if (this.styleCache[elemId][key] !== val) {
              ...
              results1.push(this.styleCache[elemId][key] = val);
            } else {
  ...
  if (!isNodeJs) {
    cacheFrames = function(frameset, cb) {
      var count, i, img, j, ref, results;
      frameset.loaded = [];
      count = 0;
      log("caching frameset", frameset.urls);
      results = [];
      for (i = j = 0, ref = frameset.urls.length - 1; 0 <= ref ? j <= ref : j >= ref; i = 0 <= ref ? ++j : --j) {
        img = new Image();
        ...
        results.push(img.src = frameset.urls[i]);
      }
      return results;
    };
    ...
    TouchHandler = function(elem) {
      ...
      condCall = function(fn) {
        return function(e) {
          ...
          fn.call(self, ((ref = e.touches) != null ? ref[0] : void 0) || e);
          return true;
        };
      };
  ...
  if (isNodeJs) {
    ...
    app.use("/api", function(req, res, next) {
      ...
      return req.on("end", function() {
        var e, error, event, j, len, ref, results;
